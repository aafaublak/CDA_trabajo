...
# Crear imagen DEL BALANCEADOR (2º)
...
# Solo 1 vez
  ...
  Start-Process $VBOX_MANAGE  "guestproperty set $MV_BALANCEADOR /DSBOX/eth/3/type dhcp" -NoNewWindow -Wait    
  #gateway que utliza VBox para salida a red externa
...
# Solo 1 vez
  ...
  Start-Process $VBOX_MANAGE  "guestproperty set $MV_APACHE1 /DSBOX/eth/1/type dhcp" -NoNewWindow -Wait    
  ...
  Start-Process $VBOX_MANAGE  "guestproperty set $MV_APACHE1 /DSBOX/default_nameserver 8.8.8.8"  -NoNewWindow -Wait
...
# Solo 1 vez
  ...
  Start-Process $VBOX_MANAGE  "guestproperty set $MV_APACHE2 /DSBOX/eth/1/type dhcp" -NoNewWindow -Wait    
  ...
  Start-Process $VBOX_MANAGE  "guestproperty set $MV_APACHE2 /DSBOX/default_nameserver 8.8.8.8"  -NoNewWindow -Wait
...
if (!(Test-Path -Path "$DIR_BASE\$MV_DISCOS"))  {
  ...
  Start-Process $VBOX_MANAGE  "guestproperty set $MV_DISCOS /DSBOX/eth/1/type dhcp" -NoNewWindow -Wait
